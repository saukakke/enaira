...
<body>
    ...
    <main class="container">
        <h1 class="h1">Add New Partner Details</h1>
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="number" minlength="11" maxlength="11" class="form-control" placeholder="Partner Phone Number">
                </div>
            </div>
            ...
            <div class="col-sm-12 col-lg-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea name="address" cols="5" style="font-size: medium;" rows="5" placeholder="Partner Address"></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="btnDiv">
                <button class="btn btn-success">Add Partner</button>
            </div>
        </div>
